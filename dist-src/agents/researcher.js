...
export class Researcher {
    ...
    async performTextSearch(query) {
        try {
            ...
            const result = await sendNIMInferenceRequest(this.config.defaultModel, prompt, {
                max_tokens: 1000,
                temperature: 0.7
            });
            return result;
    ...
    async performMultimodalSearch(query) {
        try {
            ...
            const result = await sendNemotronVisionInferenceRequest(this.config.multimodalModel, prompt, undefined, // In a real implementation, this would be base64 image data
            {
                max_tokens: 1000,
                temperature: 0.7
            });
