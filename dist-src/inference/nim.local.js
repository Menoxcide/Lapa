 ...
 */
export async function isNIMAvailable(containerName = NIM_CONTAINER_NAME) {
    try {
 ...
 */
export async function isNemotronVisionAvailable() {
 ...
 */
export async function startNIMContainer(modelName, useFP8 = false) {
 ...
 * @returns Promise that resolves when container is ready
 */
export async function startNemotronVisionContainer(useFP8 = false) {
    try {
 ...
 */
async function waitForNIMReady(port = NIM_PORT, timeout = 30000) {
 ...
 */
export async function stopNIMContainer(containerName = NIM_CONTAINER_NAME) {
    try {
 ...
 * @returns Promise that resolves when container is stopped
 */
export async function stopNemotronVisionContainer() {
 ...
 */
export async function sendNIMInferenceRequest(model, prompt, parameters = {}, useNemotronVision = false) {
 ...
 * @returns Model response
 */
export async function sendNemotronVisionInferenceRequest(model = 'nemotron-vision', prompt, imageBase64, parameters = {}) {
    try {
 ...
 */
export async function initializeNIMEnvironment(includeNemotronVision = false) {
    try {
