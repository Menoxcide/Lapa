...
describe('CloudNIMIntegration', () => {
    ...
    describe('sendInferenceRequest', () => {
        it('should send inference request successfully', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(`${mockApiBase}/v1/completions`, expect.objectContaining({
                method: 'POST',
                headers: {
    ...
    describe('listModels', () => {
        it('should list models successfully', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(`${mockApiBase}/v1/models`, expect.objectContaining({
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${mockApiKey}`
                }
    ...
    describe('getModelInfo', () => {
        it('should get model info successfully', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(`${mockApiBase}/v1/models/test-model`, expect.objectContaining({
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${mockApiKey}`
                }
    ...
    describe('checkHealth', () => {
        it('should check health successfully when service is up', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(`${mockApiBase}/health`, expect.objectContaining({
                method: 'GET'
            }));
        });
