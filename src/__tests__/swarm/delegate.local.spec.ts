...
describe('Swarm Delegate Local Integration', () => {
  ...
  describe('Local Delegation', () => {
    it('should delegate to local agent when available and within latency target', async () => {
      ...
      (sendOllamaChatRequest as jest.Mock).mockResolvedValue(mockResult);
    ...
    it('should fall back to consensus delegation when local delegation fails', async () => {
      ...
      (sendOllamaChatRequest as jest.Mock).mockRejectedValue(new Error('Local inference unavailable'));
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle delegation with malformed task data', async () => {
      ...
      (sendOllamaChatRequest as jest.Mock).mockResolvedValue({ response: 'Task completed' });
  ...
  describe('Convenience Function', () => {
    it('should delegate tasks using convenience function', async () => {
      ...
      // Mock successful response
      (sendOllamaChatRequest as jest.Mock).mockResolvedValue({ response: 'Task completed via convenience function' });
