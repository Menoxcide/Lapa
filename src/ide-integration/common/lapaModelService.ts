...
export interface ILAPAModelService {
...
export const ILAPAModelService = createDecorator<ILAPAModelService>('voidLAPAModelService');

class LAPAModelService extends Disposable implements ILAPAModelService {
	_serviceBrand: undefined;
	static readonly ID = 'voidLAPAModelService';
...
registerSingleton(ILAPAModelService, LAPAModelService, InstantiationType.Eager);
