...
// gets converted to --vscode-void-greenBG, see lapa.css, asCssVariable
registerColor('lapa.greenBG', configOfBG(acceptBG), '', true);
registerColor('lapa.redBG', configOfBG(rejectBG), '', true);
registerColor('lapa.sweepBG', configOfBG(sweepBG), '', true);
registerColor('lapa.highlightBG', configOfBG(highlightBG), '', true);
registerColor('lapa.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
