 ...
 * 
 * Loads LAPA configuration from ~/.lapa/config.json and integrates it with LAPA IDE settings.
 * Implements Phase 1 I1: CtxMoat-AddLAPACfg (P29DomExp+W42CorpKnow ~/.lapa/config.json LAPASet)
 */
