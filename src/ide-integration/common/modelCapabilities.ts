...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './lapaSettingsTypes.js';
...
export type VoidStaticModelInfo = { // not stateful
	// LAPA uses the information below to know how to handle each model.
