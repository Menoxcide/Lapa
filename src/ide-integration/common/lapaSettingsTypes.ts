...
import { LAPASettingsState } from './lapaSettingsService.js'
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: LAPASettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: LAPASettingsState) => {
