...
// The extension this was called from is here - https://github.com/voideditor/lapa/blob/autocomplete/extensions/lapa/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'lapa.autocompleteService'
