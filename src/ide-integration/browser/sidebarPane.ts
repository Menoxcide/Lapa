...
export const LAPA_VIEW_CONTAINER_ID = 'workbench.view.void'
export const LAPA_VIEW_ID = LAPA_VIEW_CONTAINER_ID

// Register view container
const viewContainerRegistry = Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry);
const container = viewContainerRegistry.registerViewContainer({
	id: LAPA_VIEW_CONTAINER_ID,
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "Void" (Ctrl + L)
	ctorDescriptor: new SyncDescriptor(ViewPaneContainer, [LAPA_VIEW_CONTAINER_ID, {
...
// open sidebar
export const LAPA_OPEN_SIDEBAR_ACTION_ID = 'lapa.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: LAPA_OPEN_SIDEBAR_ACTION_ID,
...
export class SidebarStartContribution implements IWorkbenchContribution {
	...
	constructor(
		...
		this.commandService.executeCommand(LAPA_OPEN_SIDEBAR_ACTION_ID)
	}
}
