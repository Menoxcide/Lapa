...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/lapa/common/lapaSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { LAPASettingsState } from '../../../../../../../workbench/contrib/lapa/common/lapaSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/lapa/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/lapa/common/refreshModelService.js';
import { ILAPASettingsService } from '../../../../../../../workbench/contrib/lapa/common/lapaSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/lapa/browser/extensionTransferService.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/lapa/common/metricsService.js'
...
import { ILAPACommandBarService } from '../../../lapaCommandBarService.js'
...
let settingsState: LAPASettingsState
const settingsStateListeners: Set<(s: LAPASettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(ILAPASettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		lapaCommandBarService: accessor.get(ILAPACommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, lapaCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		lapaCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		lapaCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		ILAPASettingsService: accessor.get(ILAPASettingsService),
		...
		ILAPAModelService: accessor.get(ILAPAModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		ILAPACommandBarService: accessor.get(ILAPACommandBarService),
