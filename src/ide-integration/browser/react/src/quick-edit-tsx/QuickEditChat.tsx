...
import { LAPA_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/lapa/common/lapaSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(LAPA_CTRL_K_ACTION_ID)?.getLabel()
