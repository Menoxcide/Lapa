...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@ILAPAModelService lapaModelService: ILAPAModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@ILAPACommandBarService private readonly commandBarService: ILAPACommandBarService,
		...
		this.callTool = {
			read_file: async ({ uri, startLine, endLine, pageNumber }) => {
				await lapaModelService.initializeModel(uri)
				const { model } = await lapaModelService.getModelSafe(uri)
		...
		this.stringOfResult = {
			...
			search_in_file: (params, result) => {
				const { model } = lapaModelService.getModel(params.uri)
			...
			edit_file: (params, result) => {
				const lintErrsString = (
					this.lapaSettingsService.state.globalSettings.includeToolLintErrors ?
