...
import { mountLapaSelectionHelper } from './react/out/void-editor-widgets-tsx/index.js';
...
export type LapaSelectionHelperProps = {
...
export class SelectionHelperContribution extends Disposable implements IEditorContribution, IOverlayWidget {
	public static readonly ID = 'editor.contrib.lapaSelectionHelper';
	// react
	...
	constructor(
		...
		@ILAPASettingsService private readonly _lapaSettingsService: ILAPASettingsService
	) {
		super();
		...
		this._instantiationService.invokeFunction(accessor => {
			...
			const res = mountLapaSelectionHelper(content, accessor);
			if (!res) return;
	...
	private _showHelperForSelection(selection: Selection): void {
		...
		// rerender
		const enabled = this._lapaSettingsService.state.globalSettings.showInlineSuggestions
