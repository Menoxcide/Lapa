...
import { getSessionShareInfo, generateSessionShareLink } from '@lapa/core/swarm/sessions.js';
...
const SwarmView: React.FC<SwarmViewProps> = ({
  ...
  return (
    <div className="swarm-view relative w-full h-full bg-gray-100 overflow-hidden">
      {/* Controls */}
