 ...
 */
async function waitForOllamaReady(timeout: number = 30000): Promise<void> {
 ...
 */
export async function sendOllamaInferenceRequest(
    model: string,
    prompt: string,
 ...
 */
export async function initializeOllamaEnvironment(): Promise<void> {
    try {
