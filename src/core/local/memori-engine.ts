...
export class MemoriEngine {
   ...
   * Convenience method that wraps autoGenMemoriSQLite.storeEntity
   */
  async store(entity: {
    id: string;
    type: string;
    ...
    await autoGenMemoriSQLite.storeEntity({
      id: entity.id,
      type: entity.type,
      value: entity.value || entity.content || '',
      confidence: entity.confidence || 1.0,
      timestamp: new Date(),
      sourceAgentId: entity.sourceAgentId,
