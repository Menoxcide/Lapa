...
describe('ConsensusVotingSystem', () => {
  ...
  describe('calculateAgentWeight', () => {
    it('should calculate agent weight based on expertise', () => {
      ...
      const agentWith2Expertise: Agent = {
        id: 'test-agent-1',
        type: 'coder',
        name: 'Test Agent',
      ...
      const weight1 = (votingSystem as any).calculateAgentWeight(agentWith2Expertise);
      expect(weight1).toBe(1); // Max(1, 2/2) = 1
      
      const agentWith5Expertise: Agent = {
        id: 'test-agent-2',
        type: 'coder',
        name: 'Test Agent 2',
      ...
      const weight2 = (votingSystem as any).calculateAgentWeight(agentWith5Expertise);
  ...
  describe('getTotalAgentWeight', () => {
    it('should calculate total weight of all registered agents', () => {
      const totalWeight = (votingSystem as any).getTotalAgentWeight();
  ...
  describe('generateSessionId', () => {
    it('should generate unique session IDs', () => {
      const id1 = (votingSystem as any).generateSessionId('Test Topic');
      const id2 = (votingSystem as any).generateSessionId('Test Topic');
