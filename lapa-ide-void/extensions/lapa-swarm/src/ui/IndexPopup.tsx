...
interface IndexPopupProps {
  onClose?: () => void;
  onIndexComplete?: (context: any) => void;
}

const IndexPopup: React.FC<IndexPopupProps> = ({ onClose, onIndexComplete }) => {
  ...
  return (
    <div className="index-popup fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g., 'Index the entire codebase for React components and API endpoints'"
          ...
          <div>
            ...
            >
              ...
              <label
                htmlFor="file-input"
                className="inline-block px-4 py-2 bg-gray-100 rounded hover:bg-gray-200 cursor-pointer text-sm"
              >
                Browse Files
              </label>
            </div>
              ...
              <div className="mt-2 space-y-1">
                {droppedFiles.map((file, idx) => (
                  ...
                  >
                    <span>{file.name}</span>
                    <button
                      onClick={() => setDroppedFiles(prev => prev.filter((_, i) => i !== idx))}
        ...
        <div className="flex items-center justify-end gap-2 p-6 border-t bg-gray-50">
          ...
          <button
            onClick={handleIndex}
            disabled={isIndexing || (!input.trim() && droppedFiles.length === 0)}
