...
export class AgentDocumentationGenerator {
  ...
  generateAgentDocumentation(agent: Agent, options: GenerationOptions = {}): string {
    const doc: AgentDocumentation = this.createAgentDocumentation(agent);
   ...
   * @param options Generation options
   */
  async saveAgentDocumentation(agent: Agent, filename: string, options: GenerationOptions = {}): Promise<void> {
   ...
   * @param options Generation options
   */
  async saveAgentsDocumentation(agents: Agent[], filename: string, options: GenerationOptions = {}): Promise<void> {
   ...
   */
  private createAgentDocumentation(agent: Agent): AgentDocumentation {
    return {
      name: agent.name,
      type: agent.type,
   ...
   */
  private formatDocumentation(doc: AgentDocumentation, options: GenerationOptions): string {
   ...
   * @returns Formatted Markdown content
   */
  private formatSingleAgentDocumentation(doc: AgentDocumentation, _options: GenerationOptions): string {
   ...
   */
  private getAgentUsage(type: AgentType): string {
    const usage: Record<AgentType, string> = {
   ...
   */
  private getAgentIntegration(type: AgentType): string {
    const integration: Record<AgentType, string> = {
