...
const graphNodeSchema = zod_1.z.object({
    id: zod_1.z.string(),
    type: zod_1.z.enum(['agent', 'process', 'decision']),
...
const stateTransitionSchema = zod_1.z.object({
    fromNodeId: zod_1.z.string(),
    toNodeId: zod_1.z.string(),
    timestamp: zod_1.z.date(),
    contextBefore: zod_1.z.record(zod_1.z.unknown()),
    contextAfter: zod_1.z.record(zod_1.z.unknown())
});
// Zod schema for OrchestrationResult validation
const orchestrationResultSchema = zod_1.z.object({
    success: zod_1.z.boolean(),
    finalState: workflowStateSchema, // Use the actual schema instead of z.any()
    output: zod_1.z.unknown().optional(),
    executionPath: zod_1.z.array(zod_1.z.string()),
