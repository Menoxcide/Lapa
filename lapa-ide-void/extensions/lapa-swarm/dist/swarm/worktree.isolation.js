...
exports.gitWorktreeManager = exports.GitWorktreeManager = void 0;
...
class GitWorktreeManager {
    worktrees = new Map();
    basePath;
    constructor(basePath = '.lapa/worktrees') {
    ...
    async createWorktree(agentId, options = {}) {
        try {
            ...
            const worktreePath = (0, path_1.join)(this.basePath, worktreeId);
     ...
     * @returns Promise that resolves with the operation result
     */
    async lockWorktree(worktreeId, reason) {
        try {
            const worktree = this.worktrees.get(worktreeId);
            if (!worktree) {
                return {
     ...
     * @returns Promise that resolves with the operation result
     */
    async unlockWorktree(worktreeId) {
        try {
            const worktree = this.worktrees.get(worktreeId);
            if (!worktree) {
                return {
...
exports.gitWorktreeManager = new GitWorktreeManager();
