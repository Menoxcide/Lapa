...
exports.BenchmarkSuiteV2 = void 0;
exports.getBenchmarkSuiteV2 = getBenchmarkSuiteV2;
...
class BenchmarkSuiteV2 {
     ...
     */
    async runBenchmark(name, category, benchmarkFn) {
        if (!this.config.enabled) {
            return {
                name,
                category,
     ...
     */
    async benchmarkHandoffPerformance() {
     ...
     */
    async benchmarkContextCompression() {
    ...
    async runBenchmarkSuite() {
        ...
        const suiteDuration = perf_hooks_1.performance.now() - suiteStart;
...
exports.BenchmarkSuiteV2 = BenchmarkSuiteV2;
/**
 * Default benchmark suite instance (lazy initialization)
 */
let defaultBenchmarkSuite = null;
/**
 * Get or create default benchmark suite
 */
function getBenchmarkSuiteV2(config) {
    if (!defaultBenchmarkSuite) {
        defaultBenchmarkSuite = new BenchmarkSuiteV2(config);
    }
    return defaultBenchmarkSuite;
}
//# sourceMappingURL=bench-v2.js.map