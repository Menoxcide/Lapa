...
exports.agentDocumentationGenerator = exports.AgentDocumentationGenerator = void 0;
...
class AgentDocumentationGenerator {
    ...
    async saveAgentDocumentation(agent, filename, options = {}) {
        ...
        const outputPath = (0, path_1.join)(this.outputPath, filename);
...
exports.AgentDocumentationGenerator = AgentDocumentationGenerator;
// Export singleton instance
exports.agentDocumentationGenerator = new AgentDocumentationGenerator();
