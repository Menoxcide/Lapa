...
exports.personaManager = exports.PersonaManager = void 0;
/**
...
class PersonaManager {
     ...
     */
    getPersonasByExpertise(expertiseArea) {
        return Array.from(this.personas.values()).filter(persona => persona.expertiseAreas.some(area => area.toLowerCase().includes(expertiseArea.toLowerCase())));
    }
    /**
     ...
     */
    applyPersonaToContent(personaId, content) {
...
exports.personaManager = new PersonaManager();
