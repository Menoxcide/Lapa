...
class Researcher {
     ...
     */
    async aiQSearch(query, multimodal = false) {
        // Validate inputs
    ...
    async performTextSearch(query) {
        try {
            ...
            const result = await (0, nim_local_ts_1.sendNIMInferenceRequest)(this.config.defaultModel, prompt, {
                max_tokens: 1000,
                temperature: 0.7
            });
            return result;
     ...
     * @returns Search result
     */
    async performMultimodalSearch(query) {
        try {
            // In a real implementation, this would interface with the AI-Q RAG system
            ...
            const result = await (0, nim_local_ts_1.sendNemotronVisionInferenceRequest)(this.config.multimodalModel, prompt, undefined, // In a real implementation, this would be base64 image data
            {
                max_tokens: 1000,
                temperature: 0.7
            });
