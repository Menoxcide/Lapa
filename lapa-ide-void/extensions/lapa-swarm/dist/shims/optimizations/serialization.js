...
exports.initializeFastSerializer = initializeFastSerializer;
...
class SimpleLRUCache {
    ...
    get(key) {
        ...
        if (entry) {
            ...
            if (perf_hooks_1.performance.now() - entry.timestamp < this.ttl) {
...
class FastSerializer {
     ...
     */
    serializeEventForInterop(event) {
     ...
     */
    deserializeEventFromInterop(interopEvent) {
        // Use fast path for simple events if enabled
    ...
    fastDeserialize(interopEvent) {
        ...
        else if (interopEvent.payload.startsWith('"') &&
     ...
     * @returns Deserialized LAPA event
     */
    standardDeserialize(interopEvent) {
