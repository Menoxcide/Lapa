 ...
 */
async function isNIMAvailable(containerName = NIM_CONTAINER_NAME) {
    try {
 ...
 */
async function isNemotronVisionAvailable() {
 ...
 */
async function startNIMContainer(modelName, useFP8 = false) {
 ...
 * @returns Promise that resolves when container is ready
 */
async function startNemotronVisionContainer(useFP8 = false) {
    try {
 ...
 */
async function stopNIMContainer(containerName = NIM_CONTAINER_NAME) {
    try {
 ...
 * @returns Promise that resolves when container is stopped
 */
async function stopNemotronVisionContainer() {
 ...
 */
async function sendNIMInferenceRequest(model, prompt, parameters = {}, useNemotronVision = false) {
 ...
 * @returns Model response
 */
async function sendNemotronVisionInferenceRequest(model = 'nemotron-vision', prompt, imageBase64, parameters = {}) {
    try {
 ...
 */
async function initializeNIMEnvironment(includeNemotronVision = false) {
    try {
