...
exports.CoderAgentWrapper = void 0;
 ...
 */
class CodeGenerationTool extends agent_tool_ts_2.BaseAgentTool {
    constructor() {
        super('code-generation', 'code-generation', 'Generates code based on requirements and context', '1.0.0');
    }
    /**
 ...
 * Code Review Tool
 */
class CodeReviewTool extends agent_tool_ts_2.BaseAgentTool {
    constructor() {
        super('code-review', 'code-review', 'Reviews code for quality, best practices, and potential issues', '1.0.0');
    }
    /**
     ...
     */
    simulateCodeReview(code, guidelines) {
        // This is a simplified simulation - in a real implementation, this would
 ...
 */
class CoderAgentWrapper extends agent_tool_ts_1.HelixTeamAgentWrapper {
    constructor(id, name, registry, multimodalConfig) {
        // Initialize with coder-specific capabilities
        super(id, 'coder', name, ['code-generation', 'code-review', 'refactoring', 'implementation', 'vision-code-generation'], 0, // Initial workload
        5, // Capacity
        registry);
     ...
     */
    registerCoderTools(registry, multimodalConfig) {
...
exports.CoderAgentWrapper = CoderAgentWrapper;
//# sourceMappingURL=coder-wrapper.js.map