...
const advanced_voice_agent_ts_1 = require("../../multimodal/advanced-voice-agent.ts");
describe('Voice Agent', () => {
    ...
    beforeEach(() => {
        ...
        voiceAgent = new advanced_voice_agent_ts_1.AdvancedVoiceAgent(config);
    });
    ...
    describe('Dictation', () => {
        it('should start and stop dictation', async () => {
            ...
            await voiceAgent.addToDictationBuffer(audioBuffer);
            // Stop dictation
...
//# sourceMappingURL=voice-agent.test.js.map