...
const artifacts_builder_tool_ts_1 = require("../../multimodal/artifacts-builder-tool.ts");
describe('ArtifactsBuilderTool', () => {
    let artifactsBuilderTool;
    beforeEach(() => {
        ...
        artifactsBuilderTool = new artifacts_builder_tool_ts_1.ArtifactsBuilderTool(config);
    });
    ...
    describe('Tool Execution', () => {
        it('should handle generateReactCodeFromDesign action', async () => {
            ...
            const mockGenerateReactCodeFromDesign = vi.spyOn(artifactsBuilderTool, 'handleGenerateReactCodeFromDesign')
...
//# sourceMappingURL=artifacts-builder-tool.test.js.map