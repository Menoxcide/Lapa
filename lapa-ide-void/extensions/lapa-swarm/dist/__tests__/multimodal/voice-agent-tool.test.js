...
describe('Voice Agent Tool', () => {
    let voiceAgentTool;
    beforeEach(() => {
        voiceAgentTool = new voice_agent_tool_ts_1.VoiceAgentTool();
    });
    ...
    describe('Transcription Actions', () => {
        it('should handle transcribe action', async () => {
            ...
            const mockProcessAudio = vi.spyOn(voiceAgentTool, 'handleTranscribe')
    ...
    describe('Synthesis Actions', () => {
        it('should handle synthesize action', async () => {
            ...
            const mockGenerateAudio = vi.spyOn(voiceAgentTool, 'handleSynthesize')
    ...
    describe('Question Answering Actions', () => {
        it('should handle ask action', async () => {
            ...
            const mockAskQuestion = vi.spyOn(voiceAgentTool, 'handleAsk')
    ...
    describe('Voice Command Actions', () => {
        it('should handle executeCommand action', async () => {
            ...
            const mockExecuteVoiceCommand = vi.spyOn(voiceAgentTool, 'handleExecuteCommand')
    ...
    describe('Dictation Actions', () => {
        it('should handle startDictation action', async () => {
            ...
            const mockStartDictation = vi.spyOn(voiceAgentTool, 'voiceAgent', 'get')
                .mockReturnValue({
        ...
        it('should handle stopDictation action', async () => {
            ...
            const mockStopDictation = vi.spyOn(voiceAgentTool, 'voiceAgent', 'get')
                .mockReturnValue({
...
//# sourceMappingURL=voice-agent-tool.test.js.map