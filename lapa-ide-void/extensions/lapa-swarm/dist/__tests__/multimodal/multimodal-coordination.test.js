...
describe('Multimodal Coordination', () => {
    ...
    beforeEach(() => {
        ...
        toolRegistry = new agent_tool_1.AgentToolRegistry();
        // Register tools
    ...
    describe('Event-Based Coordination', () => {
        it('should publish and handle modality switch events', async () => {
            ...
            event_bus_1.eventBus.subscribe.mockImplementation((eventType, handler) => {
...
//# sourceMappingURL=multimodal-coordination.test.js.map