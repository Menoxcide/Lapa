...
describe('Vision-Voice Controller', () => {
    ...
    describe('Modality Management', () => {
        it('should set and get current modality', () => {
            ...
            expect(event_bus_ts_1.eventBus.publish).toHaveBeenCalledTimes(2);
            expect(event_bus_ts_1.eventBus.publish).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('Processing Order Determination', () => {
        it('should use current modality when explicitly set', () => {
            ...
            const order = visionVoiceController.getProcessingOrder(input);
            expect(order).toEqual(['vision']);
            visionVoiceController.setCurrentModality('voice');
            const order2 = visionVoiceController.getProcessingOrder(input);
    ...
    describe('Context Management', () => {
        it('should update and retrieve context', () => {
            ...
            visionVoiceController.updateContext('vision', { lastImage: 'image1', lastVisionOutput: 'desc1' });
            ...
            visionVoiceController.updateContext('voice', { lastAudio: 'audio1', lastVoiceOutput: 'text1' });
            // Retrieve all context
            const allContext = visionVoiceController.getContext();
    ...
    describe('Vision Agent Method Delegation', () => {
        ...
        it('should delegate generateImage to vision agent', async () => {
            ...
            const mockGenerateImage = vi.spyOn(visionVoiceController, 'generateImage')
                .mockResolvedValue(mockResult);
        ...
        it('should delegate analyzeScreenshot to vision agent', async () => {
            ...
            const mockAnalyzeScreenshot = vi.spyOn(visionVoiceController, 'analyzeScreenshot')
                .mockResolvedValue(mockResult);
        ...
        it('should delegate recognizeUIElements to vision agent', async () => {
            ...
            const mockRecognizeUIElements = vi.spyOn(visionVoiceController, 'recognizeUIElements')
                .mockResolvedValue(mockResult);
        ...
        it('should delegate generateCodeFromDesign to vision agent', async () => {
            ...
            const mockGenerateCodeFromDesign = vi.spyOn(visionVoiceController, 'generateCodeFromDesign')
                .mockResolvedValue(mockResult);
    ...
    describe('Voice Agent Method Delegation', () => {
        ...
        it('should delegate generateAudio to voice agent', async () => {
            ...
            const mockGenerateAudio = vi.spyOn(visionVoiceController, 'generateAudio')
                .mockResolvedValue(mockResult);
        ...
        it('should delegate askQuestion to voice agent', async () => {
            ...
            const mockAskQuestion = vi.spyOn(visionVoiceController, 'askQuestion')
                .mockResolvedValue(mockResult);
        ...
        it('should delegate executeVoiceCommand to voice agent', async () => {
            ...
            const mockExecuteVoiceCommand = vi.spyOn(visionVoiceController, 'executeVoiceCommand')
                .mockResolvedValue(mockResult);
...
//# sourceMappingURL=vision-voice.test.js.map