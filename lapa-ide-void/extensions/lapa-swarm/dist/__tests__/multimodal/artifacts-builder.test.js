...
const artifacts_builder_ts_1 = require("../../multimodal/artifacts-builder.ts");
describe('ArtifactsBuilder', () => {
    let artifactsBuilder;
    beforeEach(() => {
        ...
        artifactsBuilder = new artifacts_builder_ts_1.ArtifactsBuilder(config);
    });
    ...
    describe('Code Generation', () => {
      ...
      `;
            ...
            vi.spyOn(artifactsBuilder, 'visionAgent', 'get').mockReturnValue({
...
//# sourceMappingURL=artifacts-builder.test.js.map