...
const event_router_ts_1 = require("../../core/utils/event-router.ts");
...
describe('LAPA Core Event Bus Integration', () => {
    ...
    beforeEach(() => {
        ...
        (0, event_router_ts_1.setupDefaultLAPARoutes)();
        now = 0;
    });
    afterEach(() => {
        testEventBus.clear();
    ...
    describe('Event Publishing and Subscription', () => {
        ...
        it('should route events to appropriate targets', async () => {
            ...
            const routedEventPromise = new Promise((resolve) => {
    ...
    describe('Event Queue Management', () => {
        it('should queue events when exceeding maximum concurrent events', async () => {
            ...
            const limitedEventBus = new event_bus_ts_1.LAPAEventBus({ maxConcurrentEvents: 1 });
...
//# sourceMappingURL=event-bus.integration.test.js.map