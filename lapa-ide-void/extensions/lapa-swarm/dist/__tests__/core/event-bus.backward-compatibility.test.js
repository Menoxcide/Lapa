...
jest.mock('../../orchestrator/handoffs.ts', () => {
    return {
...
describe('LAPA Core Event Bus Backward Compatibility', () => {
    ...
    it('should integrate with existing handoff mechanisms', async () => {
        ...
        const { HybridHandoffSystem } = await import('../../orchestrator/handoffs.js');
    ...
    it('should integrate with existing swarm delegation', async () => {
        ...
        const { SwarmDelegate } = await import('../../swarm/delegate.js');
...
//# sourceMappingURL=event-bus.backward-compatibility.test.js.map