...
exports.FlowGuardAuthoring = exports.FlowGuardBuilder = void 0;
// Import validation functions dynamically to avoid circular dependencies
const index_ts_1 = require("../validation/index.ts");
...
class FlowGuardBuilder {
     ...
     */
    condition(category, metric, operator, value) {
...
class FlowGuardAuthoring {
     ...
     */
    static createThermalGuard(threshold, targetAgent = 'optimizer') {
     ...
     */
    static createVramGuard(threshold, fallbackProvider = 'openrouter') {
     ...
     */
    static createQualityGate(threshold, requiredAgents = ['reviewer', 'tester']) {
     ...
     */
    static createErrorResilienceGuard(threshold, targetAgent = 'debugger') {
     ...
     */
    static createPerformanceGuard(threshold, targetAgent = 'optimizer') {
    ...
    static validateConfig(config) {
        return (0, index_ts_1.validateFlowGuardsConfig)(config);
    }
    /**
     ...
     * @returns Validation result
     */
    static validateGuard(guard) {
        return (0, index_ts_1.validateFlowGuard)(guard);
    }
    /**
     ...
     * @returns YAML string representation
     */
    static configToYaml(config) {
        // Import yaml here to avoid issues with circular dependencies
        const yaml = require('js-yaml');
        return yaml.dump(config, { indent: 2, noRefs: true });
    }
}
exports.FlowGuardAuthoring = FlowGuardAuthoring;
//# sourceMappingURL=flow-guard-authoring.js.map