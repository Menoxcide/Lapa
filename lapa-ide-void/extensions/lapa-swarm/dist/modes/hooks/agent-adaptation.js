...
exports.DEFAULT_AGENT_ADAPTATION_HOOKS = void 0;
exports.createAgentBehaviorAdaptationHook = createAgentBehaviorAdaptationHook;
exports.createAgentPersonaAdaptationHook = createAgentPersonaAdaptationHook;
exports.createAgentWorkloadAdaptationHook = createAgentWorkloadAdaptationHook;
exports.createAgentToolConfigurationHook = createAgentToolConfigurationHook;
exports.createAgentCommunicationAdaptationHook = createAgentCommunicationAdaptationHook;
exports.initializeDefaultAgentAdaptationHooks = initializeDefaultAgentAdaptationHooks;
 ...
 */
function createAgentBehaviorAdaptationHook() {
    return {
        ...
        execute: async (mode, context) => {
            ...
            const modeConfig = modes_ts_1.rooModeController.getModeConfig(mode);
            if (!modeConfig) {
 ...
 * @returns ModeHook instance
 */
function createAgentPersonaAdaptationHook() {
    return {
 ...
 * @returns ModeHook instance
 */
function createAgentWorkloadAdaptationHook() {
    return {
 ...
 * @returns ModeHook instance
 */
function createAgentToolConfigurationHook() {
    return {
 ...
 * @returns ModeHook instance
 */
function createAgentCommunicationAdaptationHook() {
    return {
 ...
 */
exports.DEFAULT_AGENT_ADAPTATION_HOOKS = [
 ...
 */
function initializeDefaultAgentAdaptationHooks() {
    console.log(`Initializing ${exports.DEFAULT_AGENT_ADAPTATION_HOOKS.length} default agent adaptation hooks`);
...
//# sourceMappingURL=agent-adaptation.js.map