...
const pipeline_ts_1 = require("./pipeline.ts");
const index_ts_1 = require("./ai-q/index.ts");
async function example() {
    // Create RAG pipeline with default configuration
    const ragPipeline = new pipeline_ts_1.RAGPipeline();
    try {
        ...
        const aiqAssistant = new index_ts_1.AIQResearchAssistant();
