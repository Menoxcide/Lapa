...
type GetBuildStatusResponse = paths['/templates/{templateID}/builds/{buildID}/status']['get']['responses']['200']['content']['application/json'];
 ...
 */
type GetBuildStatusOptions = AuthOptions & {
    logsOffset?: number;
};
/**
...
declare class TemplateBase implements TemplateFromImage, TemplateBuilder, TemplateFinal {
     ...
     * ```
     */
    static getBuildStatus(data: Pick<BuildInfo, 'templateId' | 'buildId'>, options?: GetBuildStatusOptions): Promise<GetBuildStatusResponse>;
    fromDebianImage(variant?: string): TemplateBuilder;
    fromUbuntuImage(variant?: string): TemplateBuilder;
    fromPythonImage(version?: string): TemplateBuilder;
    fromNodeImage(variant?: string): TemplateBuilder;
