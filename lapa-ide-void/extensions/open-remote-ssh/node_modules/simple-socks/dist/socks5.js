...
var SocksServer = /*#__PURE__*/(0, _createClass2["default"])(function SocksServer(options) {
  ...
  this.server = _net["default"].createServer(function (socket) {
      ...
      binaryStream.word8('ver').word8('cmd').word8('rsv').word8('atyp').tap(function (args) {
        ...
        if (args.atyp === _constants.RFC_1928_ATYP.IPV4) {
          binaryStream.buffer('addr.buf', LENGTH_RFC_1928_ATYP).tap(function (args) {
            args.dst.addr = (0, _slice["default"])([]).call(args.addr.buf).join('.');
          }); // domain name
          ...
          binaryStream.word32be('addr.a').word32be('addr.b').word32be('addr.c').word32be('addr.d').tap(function (args) {
            ...
            (0, _forEach["default"])(_context = ['a', 'b', 'c', 'd']).call(_context, function (x) {
        ...
        if (args.cmd === _constants.RFC_1928_COMMANDS.CONNECT) {
          ...
          if (!connectionFilter || typeof connectionFilter !== 'function') {
            connectionFilter = function connectionFilter(destination, origin, callback) {
              return (0, _setImmediate2["default"])(callback);
            };
          ...
          }, // origin
          {
            address: socket.remoteAddress,
            port: socket.remotePort
          }, connectionFilterDomain.intercept(function (destination) {
            var sendSuccessResponse = function sendSuccessResponse(dest) {
            ...
            if (destination) {
              ...
              sendSuccessResponse(destination); // capture close of destination and emit pending disconnect
              ...
              destination = _net["default"].createConnection(args.dst.port, args.dst.addr, function () {
                return sendSuccessResponse(destination);
    ...
    function handshake(buffer) {
      _binary["default"].stream(buffer).word8('ver').word8('nmethods').buffer('methods', 'nmethods').tap(function (args) {
        ...
        var acceptedMethods = (0, _reduce["default"])(_context2 = (0, _slice["default"])([]).call(args.methods)).call(_context2, function (methods, method) {
          methods[method] = true;
          return methods;
        }, {}),
    ...
    socket.once('end', function () {
      ...
      (0, _splice["default"])(_context3 = self.activeSessions).call(_context3, (0, _indexOf["default"])(_context4 = self.activeSessions).call(_context4, socket), 1);
    });
  });
});
