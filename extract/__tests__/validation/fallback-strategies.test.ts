...
describe('FallbackStrategiesManager', () => {
  ...
  describe('executeWithFallback', () => {
    ...
    it('should execute fallback when primary operation fails', async () => {
      ...
      // Clear any default providers that might match 'test-operation'
      const defaultProviders = fallbackStrategiesManager.getRegisteredProviders();
      defaultProviders.forEach(provider => {
        fallbackStrategiesManager.removeFallbackProvider(provider);
      });
